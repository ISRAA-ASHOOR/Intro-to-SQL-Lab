...
-- Write SQL query here 
SELECT countries.name , countrylanguages.countrycode 
FROM countrylanguages 
JOIN countries ON countrycode = code 
WHERE countries.continent = 'Europe' AND language = 'Italian' AND countries.code != 'VAT' 
...
-- Looking for a city with population = 91084
SELECT countrycode , name , population FROM cities 
